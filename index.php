...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar ftco-navbar-light site-navbar-target" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Aniket Tiwari.Dev</a>
	          ...
	          <div class="row d-md-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex  align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
			            ...
			            <h1 class="mb-4 mt-3">I'm <span>Aniket Tiwari</span></h1>
	        ...
	        <div class="container">
	          <div class="row d-flex no-gutters slider-text align-items-end justify-content-end" data-scrollax-parent="true">
		          ...
		          <div class="one-forth d-flex align-items-center ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
		          	<div class="text">
		          		<span class="subheading">Hello!</span>
			            <h1 class="mb-4 mt-3">I'm a <span>Web Developer</span> based in Delhi, INDIA</h1>
			            <p><a href="#" class="btn btn-primary py-3 px-4">Hire me</a> <a href="#" class="btn btn-white btn-outline-white py-3 px-4">My works</a></p>
		            </div>
		          </div>
	        	</div>
    		...
    		<div class="row d-flex">
    			...
    			<div class="col-md-6 col-lg-7 pl-lg-5 pb-5">
		          ...
		          <div class="col-md-12 heading-section ftco-animate">
		            ...
		            <p>I'm a Delhi-based web developer with a passion for creating exceptional digital experiences. I graduated in 2021 and honed my skills during my time as an ex-TCS employee. Now, I'm a freelance developer working with three companies. In July 2023, I completed over 12 projects, showcasing my commitment to delivering outstanding results. Let's work together to bring your digital projects to life!</p>
		            <ul class="about-info mt-4 px-md-0 px-2">
		            	<li class="d-flex"><span>Name:</span> <span>Aniket Tiwari</span></li>
		            	<!-- <li class="d-flex"><span>Date of birth:</span> <span>January 01, 1987</span></li> -->
		            	<li class="d-flex"><span>Address:</span> <span>Delhi, INDIA</span></li>
		            	<li class="d-flex"><span>Zip code:</span> <span>110059</span></li> 
		            	<li class="d-flex"><span>Email:</span> <span>aniket.tiwari136693@gmail.com</span></li>
		            	<li class="d-flex"><span>Phone: </span> <span>+91-8750116640</span></li>
		            </ul>
		          </div>
		        </div>
    		...
    		<div class="row">
					...
					<div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1">
							...
							<div class="desc">
								<h3 class="mb-5">Product Shoot</h3>
							</div>
						</a>
					</div>
					<div class="col-md-4 text-center d-flex ftco-animate">
					...
					<div class="col-md-4 text-center d-flex ftco-animate">
						<a href="#" class="services-1">
							<span class="icon">
								<i class="icon-signal_wifi_4_bar"></i>
							</span>
							<div class="desc">
								<h3 class="mb-5">SMO/SMM</h3>
							</div>
						</a>
					</div>
				</div>
        ...
        <div class="row d-flex contact-info mb-5">
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p>Uttam Nagar, New Delhi-59, India </p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="tel:8750116640">+91-8750116640</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="mailto:aniket.tiwari136693@gmail.com">aniket.tiwari136693@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-6 col-lg-3 d-flex ftco-animate">
          	<div class="align-self-stretch box p-4 text-center">
	            ...
	            <p><a href="#">anikettiwari.dev.com</a></p>
	          </div>
          </div>
        </div>
  ...
  Copyright &copy;2021-<script>document.write(new Date().getFullYear());</script> All rights reserved To AniketTiwari.Dev</p>
          </div>
        </div>
      </div>
      <?php include 'whatssapp-chat-box.php';?>
    </footer>
